...
Call log:
  - waiting for locator('tbody[id*="SuggestTable-tblBody"]').locator('tr[role="row"]').nth(1)
    - locator resolved to <tr role="row" tabindex="-1" aria-rowindex="2" data-sap-ui-render="" aria-selected="false" id="__item51-__clone299" data-sap-ui="__item51-__clone299" class="sapMLIB sapMLIB-CTX sapMLIBShowSeparator sapMLIBTypeActive sapMLIBActionable sapMLIBHoverable sapMLIBFocusable sapMListTblRow">…</tr>
