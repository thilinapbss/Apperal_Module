...
- Location: e2e\apparel_regression_testing.spec.ts:710:7
...
Call log:
  - waiting for locator('#login-btn')
    - locator resolved to <button class="btn" type="submit" id="login-btn">Sign In</button>
...
> 78  |     await this.loginButton.click();
  ...
  148 | 
  149 |   /**
  150 |    * Check if username input is focused
  151 |    */
  152 |   async isUsernameInputFocused(): Promise<boolean> {
  153 |     return await this.usernameInput.evaluate((el) => el === document.activeElement);
  154 |   }
  155 | 
  156 |   /**
  157 |    * Clear all form fields
  158 |    */
  159 |   async clearFormFields() {
  160 |     await this.usernameInput.clear();
  161 |     await this.passwordInput.clear();
  162 |   }
  163 | }
  164 | 
```