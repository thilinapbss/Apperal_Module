...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 16. Upload Excel file - PO Summary format1.xlsx
- Location: e2e\apparel_regression_testing.spec.ts:260:7
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Excel Upload' }).first()
    - locator resolved to <button id="__button8" data-sap-ui-render="" data-ui5-accesskey="e" data-sap-ui="__button8" class="sapMBtnBase sapMBtn">…</button>
