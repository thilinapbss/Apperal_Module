...
Locator: locator('.lp-group-container[data-group="other1"]').locator('.lp-group-tiles').getByRole('link', { name: 'Buyer PO Upload Tile', exact: true })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.lp-group-container[data-group="other1"]').locator('.lp-group-tiles').getByRole('link', { name: 'Buyer PO Upload Tile', exact: true })
