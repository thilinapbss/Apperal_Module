...
Call log:
  - waiting for locator('div[id*="FieldValueHelp::Customer::Dialog::qualifier"]').locator('tbody tr[data-sap-ui-rowindex]').first()
    - locator resolved to <tr role="row" aria-rowindex="2" aria-selected="false" data-sap-ui-rowindex="0" class="sapUiTableRow sapUiTableContentRow sapUiTableTr sapUiTableFirstRow" id="apperal.stylemaster::StyleMasterObjectPage--fe::FormContainer::GeneralInfo::FieldValueHelp::Customer::Dialog::qualifier::::Table-innerTable-rows-row0" data-sap-ui="apperal.stylemaster::StyleMasterObjectPage--fe::FormContainer::GeneralInfo::FieldValueHelp::Customer::Dialog::qualifier::::Table-innerTable-rows-row0">…</tr>
