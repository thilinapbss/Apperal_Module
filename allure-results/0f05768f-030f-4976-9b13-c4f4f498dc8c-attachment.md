...
```
Error: locator.click: Error: strict mode violation: locator('button[id*="StandardAction::Create"]') resolved to 2 elements:
    1) <button data-sap-ui-render="" data-ui5-accesskey="c" aria-describedby="__text23" aria-keyshortcuts="Ctrl+Enter" class="sapMBtnBase sapMBtn sapMBarChild" id="apperal.buyerpoupload::BuyerPoUploadHeaderList--fe::table::BuyerPoUploadHeader::LineItem::StandardAction::Create" data-sap-ui="apperal.buyerpoupload::BuyerPoUploadHeaderList--fe::table::BuyerPoUploadHeader::LineItem::StandardAction::Create">…</button> aka locator('[id="apperal.buyerpoupload::BuyerPoUploadHeaderList--fe::table::BuyerPoUploadHeader::LineItem::StandardAction::Create"]')
    2) <button data-sap-ui-render="" data-ui5-accesskey="c" aria-keyshortcuts="Ctrl+Enter" class="sapMBtnBase sapMBtn sapMBarChild" id="apperal.buyerpoupload::BuyerPoUploadHeaderObjectPage--fe::table::GeneralInformation::LineItem::Details1::StandardAction::Create" data-sap-ui="apperal.buyerpoupload::BuyerPoUploadHeaderObjectPage--fe::table::GeneralInformation::LineItem::Details1::StandardAction::Create">…</button> aka getByLabel('Section', { exact: true }).getByRole('button', { name: 'Create' })
