...
Call log:
  - waiting for locator('tr[id*="innerTableRow"]').first() to be visible
    14 × locator resolved to hidden <tr role="row" tabindex="-1" aria-rowindex="2" aria-current="true" data-sap-ui-render="" aria-selected="false" id="apperal.routingplan::RoutingPlansList--fe::table::RoutingPlans::LineItem-innerTableRow-__clone21" data-sap-ui="apperal.routingplan::RoutingPlansList--fe::table::RoutingPlans::LineItem-innerTableRow-__clone21" class="sapMLIB sapMLIB-CTX sapMLIBShowSeparator sapMLIBTypeNavigation sapMLIBActionable sapMLIBHoverable sapMLIBFocusable sapMTableRowCustomFocus sapMListTblRow">…</tr>
