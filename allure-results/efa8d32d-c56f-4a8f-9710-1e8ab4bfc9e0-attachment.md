...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 04. Should display Merchandising Process tiles
- Location: e2e\apparel_regression_testing.spec.ts:140:7
...
Locator: locator('.lp-group-container[data-group="merchandising"]').locator('.lp-group-tiles').getByRole('link', { name: 'Number Series Tile', exact: true })
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 60000ms
  - waiting for locator('.lp-group-container[data-group="merchandising"]').locator('.lp-group-tiles').getByRole('link', { name: 'Number Series Tile', exact: true })
