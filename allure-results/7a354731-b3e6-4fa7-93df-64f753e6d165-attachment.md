...
- Location: e2e\apparel_regression_testing.spec.ts:65:7
...
Locator: locator('a:has-text("Buyer PO Upload"), a[href*="buyerpoupload"], a[href*="BuyerPO"]').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Buyer PO Upload"), a[href*="buyerpoupload"], a[href*="BuyerPO"]').first()
