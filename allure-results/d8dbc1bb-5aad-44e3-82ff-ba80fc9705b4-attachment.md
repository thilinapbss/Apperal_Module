...
Call log:
  - waiting for locator('div[id*="FieldValueHelp::Customer::Dialog::qualifier"]').locator('tbody tr[data-sap-ui-rowindex]').nth(5)
    - locator resolved to <tr role="row" aria-rowindex="7" aria-selected="false" data-sap-ui-rowindex="5" class="sapUiTableRow sapUiTableContentRow sapUiTableTr" id="apperal.stylemaster::StyleMasterObjectPage--fe::FormContainer::GeneralInfo::FieldValueHelp::Customer::Dialog::qualifier::::Table-innerTable-rows-row5" data-sap-ui="apperal.stylemaster::StyleMasterObjectPage--fe::FormContainer::GeneralInfo::FieldValueHelp::Customer::Dialog::qualifier::::Table-innerTable-rows-row5">…</tr>
