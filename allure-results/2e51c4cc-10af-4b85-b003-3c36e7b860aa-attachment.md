...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 02. Should display error message on invalid credentials
- Location: e2e\apparel_regression_testing.spec.ts:190:7

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at http://kgntest.ddns.net:4005/
Call log:
