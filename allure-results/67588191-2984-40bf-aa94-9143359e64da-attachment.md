...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 27. Click on Segment Master tile and verify navigation
- Location: e2e/apparel_regression_testing.spec.ts:378:7
...
Locator: locator('.lp-group-container[data-group="other1"]').locator('.lp-group-tiles').getByRole('link', { name: 'Segment Master Tile', exact: true })
Expected: visible
Timeout: 60000ms
...
Call log:
  ...
  - waiting for locator('.lp-group-container[data-group="other1"]').locator('.lp-group-tiles').getByRole('link', { name: 'Segment Master Tile', exact: true })
