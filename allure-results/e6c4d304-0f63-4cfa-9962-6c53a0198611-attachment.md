...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div data-sap-ui-render="" id="__wrapper8-__clone179" data-sap-ui="__wrapper8-__clone179">…</div> from <div id="sap-ui-static" data-sap-ui-area="sap-ui-static">…</div> subtree intercepts pointer events
