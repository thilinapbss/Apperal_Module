...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 09. Should display Other tiles
- Location: e2e\apparel_regression_testing.spec.ts:269:7
...
Locator: locator('.lp-group-container[data-group="other"]').locator('.lp-group-tiles').getByRole('link', { name: 'Bundle Code Generation Tile', exact: true })
Expected: visible
Timeout: 60000ms
...
Call log:
  ...
  - waiting for locator('.lp-group-container[data-group="other"]').locator('.lp-group-tiles').getByRole('link', { name: 'Bundle Code Generation Tile', exact: true })
