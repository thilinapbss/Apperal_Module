...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 38. Navigate to home page from Routing Plan
- Location: e2e\apparel_regression_testing.spec.ts:505:7
...
Call log:
  - waiting for locator('#sapUshellDashboardPage-cont') to be visible
    131 × locator resolved to hidden <section role="region" aria-label="Tile Groups" id="sapUshellDashboardPage-cont" class="sapMPageEnableScrolling sapUiScrollDelegate">…</section>
