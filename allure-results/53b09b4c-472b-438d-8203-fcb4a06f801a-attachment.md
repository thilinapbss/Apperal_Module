...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 29b. Add all segment line items
- Location: e2e/apparel_regression_testing.spec.ts:401:7

# Error details

```
TypeError: Cannot read properties of undefined (reading 'lineItemCreateButton')
```
