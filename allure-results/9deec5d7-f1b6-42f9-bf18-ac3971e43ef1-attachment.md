...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 26. Navigate to home page and verify tile content
- Location: e2e/apparel_regression_testing.spec.ts:365:7
...
Locator: locator('.lp-group-container[data-group="merchandising"]').locator('.lp-group-header')
Expected: "Merchandising Process"
Timeout: 60000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 60000ms
  - waiting for locator('.lp-group-container[data-group="merchandising"]').locator('.lp-group-header')
