...
Call log:
  - waiting for locator('button[id*="FooterBar::StandardAction::Save"]')
    - locator resolved to <button data-sap-ui-render="" data-ui5-accesskey="c" aria-keyshortcuts="Ctrl+S" aria-describedby="__text15" class="sapMBtnBase sapMBtn sapMBtnInverted sapMBarChild" id="apperal.routingplan::RoutingPlansObjectPage--fe::FooterBar::StandardAction::Save" data-sap-ui="apperal.routingplan::RoutingPlansObjectPage--fe::FooterBar::StandardAction::Save" aria-labelledby="apperal.routingplan::RoutingPlansObjectPage--fe::FooterBar::StandardAction::Save-content">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <td tabindex="-1" role="gridcell" aria-colindex="1" aria-selected="false" id="__item25-__clone194-cell0" data-sap-ui-column="__column4" class="sapMListTblCell sapMTblCellFocusable">…</td> from <div id="sap-ui-static" data-sap-ui-area="sap-ui-static">…</div> subtree intercepts pointer events
