...
```
Error: locator.fill: SyntaxError: Failed to execute 'querySelectorAll' on 'Document': 'input[role="combobox"][2]' is not a valid selector.
...
Call log:
  - waiting for locator('input[role="combobox"][2]').last()
