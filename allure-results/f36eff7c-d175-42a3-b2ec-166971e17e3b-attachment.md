...
Error: locator.click: Error: strict mode violation: locator('button[id*="VendorObjectPage--fe::FooterBar"][id*="StandardAction::Save"], button[id*="StandardAction::Create"]') resolved to 2 elements:
    1) <button data-sap-ui-render="" data-ui5-accesskey="c" aria-describedby="__text19" aria-keyshortcuts="Ctrl+Enter" class="sapMBtnBase sapMBtn sapMBarChild" id="apperal.vendor::VendorList--fe::table::Vendor::LineItem::StandardAction::Create" data-sap-ui="apperal.vendor::VendorList--fe::table::Vendor::LineItem::StandardAction::Create">…</button> aka locator('[id="apperal.vendor::VendorList--fe::table::Vendor::LineItem::StandardAction::Create"]')
...
```ts
  ...
  15 |     this.saveButton = page.locator('button[id*="VendorObjectPage--fe::FooterBar::StandardAction::Save"]');
  16 |   }
  17 | 
  ...
  76 |     const jsonString = JSON.stringify(formData, null, 2);
  77 |     fs.writeFileSync(filePath, jsonString, { encoding: 'utf-8' });
  78 |     console.log(`Vendor data captured and saved to ${filePath}`);
  79 |   }
  80 | 
