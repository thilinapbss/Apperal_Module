...
Call log:
  - waiting for locator('#sapUshellDashboardPage-cont') to be visible
    32 × locator resolved to hidden <section role="region" aria-label="Tile Groups" id="sapUshellDashboardPage-cont" class="sapMPageEnableScrolling sapUiScrollDelegate">…</section>
