...
- Name: apparel_regression_testing.spec.ts >> Apperal Module | Regression Test Suite >> 29. Enter name in Segment Master Create form
- Location: e2e/apparel_regression_testing.spec.ts:392:7
...
Call log:
  - waiting for locator('[id*="DataField::Name::Field-edit-inner"]') to be visible
